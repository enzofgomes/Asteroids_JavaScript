...
// Game constants
const SPEED = 1.60 // How fast the player moves
...
const ASTEROID_MIN_INTERVAL = 600; // Hardest
...
function startAsteroidInterval() {
  ...
  asteroidIntervalId = setInterval(spawnAsteroid, asteroidSpawnInterval);
}
function spawnAsteroid() {
  ...
  // Restart interval with new difficulty
  if (asteroidIntervalId) clearInterval(asteroidIntervalId);
  asteroidIntervalId = setInterval(spawnAsteroid, asteroidSpawnInterval);
}
